        ...
        <main className="flex-1 flex flex-col gap-6">
          ...
          <ol className="list-decimal space-y-4">
            <li className="leading-relaxed">
              Decide if you want to support both personal and team accounts.
              Personal accounts can't be disabled, but you can remove the
              dashboard sections that display them.
              <a
            ...
            <li className="leading-relaxed">
              ...
              <pre className="bg-red-50 px-2 py-1 rounded overflow-hidden text-sm inline">
                npx @usebasejump/cli@latest generate table posts title body
                published:boolean published_at:date{" "}
              </pre>
              <p>
                The CLI isn't required, but it'll help you learn the RLS policy
                options available to you.{" "}
                <a
                  className="border-b mx-2"
                  href="https://usebasejump.com/docs/example-schema"
                >
                  Learn more here
                </a>
              </p>
            ...
            <li>
              Flesh out the dashboard with any additional functionality you
              need.{" "}
              <a className="border-b mx-2" href="https://usebasejump.com/docs">
          ...
          <ul className="list-disc space-y-2">
            ...
            <li className="leading-relaxed">
              <a
                className="border-b mx-2"
                href="https://usebasejump.com/docs/testing"
              >
            ...
            <li className="leading-relaxed">
              <a
                className="border-b mx-2"
                href="https://usebasejump.com/docs/rls"
              >
            ...
            <li className="leading-relaxed">
              <a
                className="border-b mx-2"
                href="https://usebasejump.com/docs/deployment"
              >
